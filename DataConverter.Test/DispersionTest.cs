...
namespace DataConverter.Test
{
    ...
    public class DispersionTest
    {
        ...
        {
            double range = 16230;
            var verticalDispersion = dispersion.CalculateVerticalDispersion(range, dispersion.CalculateHorizontalDispersion(range));
        ...
        public void VerticalDispersionCalculation_ShortRange()
        {
            ...
            double range = 3500;
            var verticalDispersion = dispersion.CalculateVerticalDispersion(maxRange, dispersion.CalculateHorizontalDispersion(range), range);
